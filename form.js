class Form {
    ...
    constructor() {
        ...
        this.question1 = createElement('h3', "Q1. if you are given a bucket biriyani you will eat or not");
        this.radio = createRadio('h3');
        this.radio.option('yes');
        this.radio.option('No');
        this.question2 = createElement('h3', "Q2.what is the android game you are playing,is it garena free fire");
        this.radio1 = createRadio('h3');
        this.radio1.option('yes');
        this.radio1.option('No');
        this.question3 = createElement('h3', "Q3. will you topup with money?");
